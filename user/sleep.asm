...
int main(int argc, char *argv[]) {
  ...
  1c:	346080e7          	jalr	838(ra) # 35e <sleep>
    exit(0);
  20:	4501                	li	a0,0
  ...
  2e:	7c658593          	addi	a1,a1,1990 # 7f0 <malloc+0xec>
  32:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3b6:	46650513          	addi	a0,a0,1126 # 818 <digits>
 3ba:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 482:	39ab8b93          	addi	s7,s7,922 # 818 <digits>
 ...
 5c2:	25290913          	addi	s2,s2,594 # 810 <malloc+0x10c>
        while(*s != 0){
